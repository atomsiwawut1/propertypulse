...
const ProfilePage = () => {
    ...
    useEffect(() => {
        const fetchUserProperties = async (userId) => {
            try {
                // Initialize and make the fetch request within the try block.
                ...
                // Set loading to false regardless of whether the fetch was successful or not.
                setLoading(false);
            }
        };
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-3/4 md:pl-4">
                            ...
                            {!loading && properties.length === 0 && (
                                <p>your have no property listing</p>
                            )}
                                ...
                                properties.map((property) => (
                                    <div key={property._id} className="mb-10"> {/* Change made here */}
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <p className="text-gray-600">Address: {property.location.city}{" "}
