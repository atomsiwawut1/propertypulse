...
const PropertyDetails = ({ property }) => {
    ...
    // Check if the property is not provided or is empty
    if (!property) {
        return <div></div>;
    }
        ...
        <main>
            <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row justify-around">
                    {/* Checking for each rate type and displaying accordingly */}
            ...
            {/* Additional details and layout as previously defined */}
            {/* Continue with the rest of the component layout */}
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                <h3 className="text-lg font-bold mb-6">Description & Details</h3>
                <div
                    className="flex justify-center gap-4 text-green-500 mb-4 text-xl space-x-9"
                >
                    <p>
                    ...
                    <p>
                        ...
                        {property.square_feet} <span className="hidden sm:inline">m<sup>2</sup></span>
                    </p>
                </div>
